                            ...
                            <div class="col-md-12">
                                ...
                                <form class="form-horizontal" method="post">
                                             <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="fname" class="form-control" id="fname" required="required" pattern="[a-zA-Z]*" autocomplete="off">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="lname" class="form-control" id="lname" required="required" pattern="[a-zA-Z]*" autocomplete="off">
                                                    </div>
                                                </div>
