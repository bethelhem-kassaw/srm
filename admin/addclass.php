...
<?php
    ...
    $query = "INSERT INTO class(`classname`,`classnumber`,`section`,`created_at`) VALUE ('$classname','$classnumber','$section',NOW())";
                            ...
                            <div class="col-md-12">
                                ...
                                <form class="form-horizontal" method="post">
                                             <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="classname" class="form-control" id="classname" required="required" autocomplete="on">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" name="section" class="form-control" id="section"  required="required" autocomplete="on">
                                                    </div>
                                                </div>
