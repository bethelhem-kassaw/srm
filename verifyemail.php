...
if(isset($_POST['verify'])){
    ...
    $verifyquery="SELECT * FROM adminteacher WHERE code=$OTPVerify";
    $runverifyquery=mysqli_query($conn,$verifyquery);
    if(mysqli_num_rows($runverifyquery)>0){
        $newquery="UPDATE adminteacher SET code=0 ";
                    ...
                    <div class="panel-body p-20">
                        ...
                        <form class="form-horizontal" method="POST">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="code" class="form-control" id="inputEmail3" placeholder="code">
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-20">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" name="verify" class="btn btn-success btn-labeled pull-right">Verify<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                </div>
                            </div>
                        </form>
                        <!-- <div class="form-group mt-20">
