...
if(isset($_POST['login']))
{
    $email = $_POST['email'];
            ...
            $sql = "select * from adminteacher where email='" . $email . "'";
            ...
            if ($result) {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    // die ("$code");
                    $updateQuery = "UPDATE `adminteacher` SET `code`='$code' WHERE email='$email'";
                    ...
                    if ($updateresult) {
                        ...
                        // $sender = 'From: bethelhemkassaw@gmail.com';
                        ...
                        echo "Failed while inserting data into the database";
                    }
                        ...
                        <form class="form-horizontal" method="POST">
                            ...
                            <div class="form-group mt-20">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" name="login" class="btn btn-success btn-labeled pull-right">Recover<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                </div>
                            </div>
                        </form>
                        <!-- <div class="form-group mt-20">
