               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="teacherdashboard.php"><h1>ONLINE STUDENT RESULT MANAGEMENT SYSTEM</h1></a>
                        </div>
...
?>
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">class Work</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="ass1" class="form-control" id="default"  required="required" autocomplete="off" placeholder="/5">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">project</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="ass2" class="form-control" id="default"  required="required" autocomplete="off" placeholder="/10">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Mid-exam</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="ass3" class="form-control" id="default"  required="required" autocomplete="off" placeholder="/20">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">test</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="ass4" class="form-control" id="default"  required="required" autocomplete="off" placeholder="/10">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Assignment</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="ass5" class="form-control" id="default"  required="required" autocomplete="off" placeholder="/5">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Final</label>
                                                    <div class="col-sm-6">
                                                        <input type="number" name="ass6" class="form-control" id="default"  required="required" autocomplete="off" placeholder="/50">
                                                    </div>
                                                </div>
